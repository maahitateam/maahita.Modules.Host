...
export const isAdmin = derived(appuser, $appuser => $appuser.isLoggedIn && $appuser.customClaims.claim === appRoles.admin);
export const isPresenter = derived(appuser, $appuser => $appuser.isLoggedIn && $appuser.customClaims.claim === appRoles.presenter);
export const isUser = derived(appuser, $appuser => $appuser.isLoggedIn && $appuser.customClaims.claim === appRoles.user);
